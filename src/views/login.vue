<template>
  <div class="loding">
    <div class="weui_cells weui_cells_form">
      ...
      <div class="weui_cell">
        <div class="weui_cell_hd margt"><label class="weui_label"><img src="/static/images/mima@3.png"
                                                                       width="25px;"></label></div>
        <div class="weui_cell_bd weui_cell_primary">
    ...
    <p class="nomessage">
      <router-link :to="{ path: 'register',query:{ customerId:getCustomerID,redirectUrl:redirectUrl} }">没有帐号?立即注册
      </router-link>
    </p>
          ...
          loginByMobile(
            ...
            if (data.code == apiStatus.SUCCESS) {
              ...
              if ($this.redirectUrl == '' || $this.redirectUrl == undefined) {
                ...
                $this.$router.push({path: '/circle', query: {customerId: $this.getCustomerID}})
              } else {
