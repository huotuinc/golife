  ...
  <div>
      ...
      <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell weui_vcode">
          ...
          <div class="weui_cell_ft">
            <a href="javascript:;" id="js-register-sendCode" v-on:click="send()"
               class="weui_btn weui_btn_mini weui_btn_primary">获取验证码</a>
          </div>
        </div>
        <div class="weui_cell">
          <div class="weui_cell_hd margt"><label class="weui_label"><img src="/static/images/mima@3.png" width="25px;"></label>
          </div>
          <div class="weui_cell_bd weui_cell_primary">
    ...
    <div class="weui_panel_bd">
      <div class="weui_media_box weui_media_text" style=" padding-top:4px;">
        ...
        <p class="weui_media_desc">新用户初次登录需设置登录密码，便于网页端登录使用。</p>
      </div>
