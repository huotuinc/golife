...
export const fetchList = (circleId, type = 0, lastId = 0)=> {
  if (bases.debug) {
    ...
    if (type == 0) {
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '美国交通部长：美国的未来同自动驾驶技术休戚相关',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/20150522141805682.png',
        pid: lastId,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://images2015.cnblogs.com/news_topic/20161027234046765-2075674400.png',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '特斯拉10月出货暴跌八成，它成了按财报节点造车的公司',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/tesla.png',
        pid: lastId + 1,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
        userLevel: 8,
        userName: 'itwriter',
        viewAmount: '3422'
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '高通第四财季净利润16亿美元 同比增长51%',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/qualcomm.gif',
        pid: lastId + 2,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: 'Visual Studio 15改进C++工程加载',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/12-08-24%2023-47-29.gif',
        pid: lastId + 3,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '美股500强前5名首次被科技企业包揽 苹果五年来一直居首',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/apple.png',
        pid: lastId + 4,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '阿里回应SEC调查及做空事件：每年双11都有各种攻击 习惯了',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/20150529141337860.png',
        pid: lastId + 5,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: 'Facebook第三季度收入、利润双双爆表 但开支太多让投资人很不满意',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/facebook.gif',
        pid: lastId + 6,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'https://news.cnblogs.com/images/logo.gif',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '混改前夕 联通签约百度引发三大猜想：集团业务引入民资？',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/baidu.jpg',
        pid: lastId,
        time: new Date().getTime() - 720000,
        userHeadUrl: 'http://common.cnblogs.com/images/ghs.png',
        userId: 1,
        userLevel: 8,
        userName: 'itwriter',
        viewAmount: '3422'
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '10年前就做出了“微信小程序”的他打算帮开发者用H5开发原生应用',
        pictureUrl: 'https://images2015.cnblogs.com/news_topic/20161102173917471-1531128049.png',
        pid: lastId + 1,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'http://common.cnblogs.com/images/ghs.png',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: 'iOS 10.1.1新功能：App Store支持支付宝了',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/20150709134830408.png',
        pid: lastId + 3,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'http://common.cnblogs.com/images/ghs.png',
        userId: 1,
      ...
      articleList.list.push({
        commentsAmount: 3452,
        concerned: false,
        name: '430万部回收Note 7该如何处理？绿色和平组织有话说',
        pictureUrl: 'https://images0.cnblogs.com/news_topic/samsung.png',
        pid: lastId + 4,
        time: new Date().getTime() - 360000,
        userHeadUrl: 'http://common.cnblogs.com/images/ghs.png',
        userId: 1,
